...
# Date:         20190130
# Description:  Spectrum Analysis on Entire Discharge for DIIID TC
# Engineer:     Tom Looby
...
#Number of Frequency Components to Annotate of Plot
n_freqs = 6    #Change as necessary
#Sampling Frequency
...
f, Pxx_den = signal.welch(TC_data.iloc[:,1], fs=sample_freq)
...
plt.figure(1)
plt.subplot(211)
plt.plot(TC_data.iloc[:,0],TC_data.iloc[:,1],'g')
